...
Route::post('contact-us', ['as' => 'contact_us1', 'uses' => 'HomeController@contactUsPost']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => 'admin'], function() {
        ...
        Route::group(['prefix'=>'settings'], function(){
            ...
            Route::post('other', ['as'=>'other_settings1', 'uses' => 'SettingsController@OtherSettingsPost']);
        });
        ...
        Route::group(['prefix'=>'users'], function(){
            ...
            Route::get('profile/change-avatar/{id}', ['as'=>'change_avatar1', 'uses' => 'UserController@changeAvatar']);
